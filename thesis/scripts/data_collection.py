...
def save_sec_data():
    ...
    converts = pd.DataFrame({
        'Issue_Date': ['2020-12-11', '2021-02-19', '2021-06-14', '2024-03-08', '2024-09-20', '2024-11-21'],
        'Principal': [650e6, 1050e6, 500e6, 800e6, 1000e6, 3000e6],
        'Coupon': [0.0075, 0.0, 0.0, 0.00625, 0.00625, 0.0],
        'Maturity': ['2025-12-15', '2027-02-15', '2028-06-15', '2030-03-15', '2028-09-15', '2029-11-15'],
        'Conversion_Price': [398, 1432, 1825, None, None, None]
    })

    # preferred shares (the alphabet soup)
    prefs = pd.DataFrame({
        'Ticker': ['STRK', 'STRF', 'STRD', 'STRC', 'STRE'],
        'Name': ['Strike', 'Strife', 'Stride', 'Stretch', 'Stream'],
        'Launch': ['2025-02', '2025-03', '2025-06', '2025-07', '2025-11'],
        'Notional': [1.39e9, 1.24e9, 1.25e9, 2.80e9, 0.715e9],
        'Dividend_Rate': [0.08, 0.10, 0.10, 0.105, 0.10],
