...
\subsubsection{Market Reflexivity}
...
\subsubsection{Merton Structural Credit Model}
...
\subsubsection{Convertible Bond Arbitrage}
...
\subsubsection{Cryptocurrency Markets and Corporate Adoption}
...
Corporate Bitcoin adoption is a newer phenomenon with limited academic coverage. MicroStrategy sits outside the scope of existing work: most corporate adopters allocated single-digit percentages of treasury to Bitcoin. MSTR made it the entire balance sheet. No framework exists for analyzing a company that has transformed itself from a software firm into a leveraged Bitcoin vehicle. Since 2024, a growing cohort of public companies have adopted variants of Strategy's model, collectively referred to as Digital Asset Treasury Companies (DATCOs). I examine these firms comparatively in Section~\ref{sec:datco_landscape}.
