\subsection{Comparative Evidence: The DATCO Landscape}
...
\subsubsection{Taxonomy and Scale}
...
\midrule
Strategy & MSTR & 713,502 & 76,052 & Software (legacy) \\
...
\paragraph{Twenty One Capital (NYSE: XXI)}
...
\paragraph{Semler Scientific (NASDAQ: SMLR)}
...
\paragraph{Genius Group (NYSE American: GNS)}
...
\paragraph{The Micro-Cap Fringe}
...
\subsubsection{The Reflexivity Gradient}
...
\begin{table}[H]
\centering
\caption[mNAV and Peak-to-Trough Declines by DATCO Scale]{mNAV and Peak-to-Trough Stock Price Declines by DATCO Scale (February 2026)}
\label{tab:reflexivity_gradient}
\begin{tabular}{@{}llrrr@{}}
\toprule
\textbf{Tier} & \textbf{Company} & \textbf{BTC Held} & \textbf{mNAV} & \textbf{Peak-to-Trough} \\
\midrule
Large & Strategy (MSTR) & 713,502 & $\sim$1.0 & $-$65\% \\
...
\subsubsection{NAV Premium Compression}

Strategy's NAV premium compressed from over 3$\times$ in late 2024 to roughly 1.3$\times$ by October 2025, eventually touching a discount in late 2025. This compression is not idiosyncratic. It reflects a sector-wide phenomenon driven by two forces.
...
\subsubsection{Systemic Implications}
...
\subsubsection{What the Comparative Evidence Shows}
