...
The event study is the core finding. MSTR systematically raises capital at substantial premiums to NAV: the average pre-event premium is 127\%, meaning the stock trades at roughly 2.3$\times$ the value of underlying Bitcoin holdings. Premiums decline in the days following issuance, falling from 127\% to 122\% within 10 trading days as the market prices in dilution. Management issues equity or converts when the spread between market valuation and NAV is wide enough to generate accretive BTC accumulation.

The premium persistence result ($\beta = 1.002$) explains why this works. Once MSTR trades at a premium, it tends to stay at a premium. Once it trades at a discount, it stays at a discount. This stickiness gives management time to execute capital raises during favorable windows rather than racing against mean-reversion.
...
At \$95,000 BTC, Strategy holds \$67.8 billion in assets against \$15.9 billion in claims: a 4.25$\times$ asset/debt ratio. Equity is worth \$51.8 billion. This cushion is substantial. Bitcoin would need to fall 76\% before equity is wiped out.

At \$35,000 BTC (a 63\% decline), asset/debt compresses to 1.57$\times$. Equity falls 83\% to \$9.0 billion. Strategy likely loses access to ATM equity issuance at attractive terms. The reflexive loop breaks or at least weakens severely.
