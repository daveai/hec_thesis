...
\begin{figure}[H]
    ...
    \end{tikzpicture}
    \caption[Strategy Capital Structure Waterfall]{Strategy Capital Structure Waterfall. The figure shows the seniority hierarchy of MSTR's financing instruments, from most senior (convertible debt) to most junior (common equity). All claims are effectively backed by Bitcoin holdings. Annual servicing costs total approximately \$850 million.}
