...
\begin{table}[H]
\centering
\caption{Descriptive Statistics (August 2020 -- January 2026)}
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{Average NAV premium around capital raise announcements. Day 0 is the announcement date. The dashed line shows the unconditional sample mean ($-8.2\%$). MSTR systematically raises capital during periods of elevated premiums.}
