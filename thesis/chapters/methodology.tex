...
At the January 31, 2026 close (\$79,000 BTC), Strategy's 713,502 BTC are worth \$56.4 billion against \$15.9 billion in total claims, yielding a 3.54$\times$ asset/debt ratio. This ratio tells you how much cushion exists before creditors face impairment.
...
The core mechanistic claim is that MSTR times capital raises to premium windows. I test this directly by identifying 23 capital raise events from SEC filings (ATM announcements, convertible offerings, preferred issuances) during the October 2024 to November 2025 period of aggressive capital formation, and measuring the NAV premium in windows around each announcement:
\begin{equation}
