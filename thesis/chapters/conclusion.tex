...
The event study provides the central result. MSTR raises capital at an average NAV premium of 127\% --- roughly 2.3$\times$ the value of its Bitcoin holdings. Premiums decline post-issuance as the market prices in dilution. This timing behavior is the operational signature of reflexive capital formation. The premium persistence result ($\beta = 1.002$) explains why it works: premium states are sticky, giving management time to execute raises during favorable conditions.

The credit analysis is simple arithmetic. At \$95,000 BTC, Strategy has a 4.25$\times$ asset/debt ratio. Bitcoin would need to fall 76\% before equity is wiped out. This is healthier than earlier periods in the company's history. But the leverage works both ways: a 50\% BTC decline produces a 65\% equity decline.
