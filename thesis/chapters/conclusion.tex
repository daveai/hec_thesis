...
The event study provides the central result. MSTR raises capital at an average NAV premium of 119\%, roughly 2.2$\times$ the value of its Bitcoin holdings. Premiums decline post-issuance as the market prices in dilution. This timing behavior is the operational signature of reflexive capital formation. The premium persistence result ($\beta = 0.991$) explains why it works: premium states are sticky, giving management time to execute raises during favorable conditions.

The credit analysis is simple arithmetic. At \$79,000 BTC, Strategy has a 3.54$\times$ asset/debt ratio. Bitcoin would need to fall 72\% before equity is wiped out. This is healthier than earlier periods in the company's history. But the leverage works both ways: a 50\% BTC decline produces a 70\% equity decline.
...
Strategy's approach represents an extreme point in corporate capital structure design. By holding 713,502 BTC against \$15.9 billion in claims, management has created a mechanism that generates value when conditions are favorable and risk when they're not. Whether the reflexive loop proves durable depends on Bitcoin prices cooperating, volatility staying elevated, and capital markets staying open. History suggests all three conditions fail periodically.
